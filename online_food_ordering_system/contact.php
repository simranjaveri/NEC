...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a class="navbar-brand" href="index.php"><span style="color:green;font-family: 'Permanent Marker', cursive;"><img src="/online_food_ordering_system/img/krishna.png" height="90" width="130"></span></a></span></a>
    <?php
	if(!empty($cust_id))
	{
	?>
  ...
  <div class="row">
    <div class="col-sm-8" style="padding:20px; border:1px solid #F0F0F0;">
	    <form method="post">
			...
			<div class="form-group">
                 <input type="tel" class="form-control" pattern="[6-9]{1}[0-9]{9}"  name="phone" placeholder="Phone(optinal) "/>
            </div>
			<div class="form-group">
    ...
    width="350"
    height="430"
    src="https://console.dialogflow.com/api-client/demo/embedded/43b0c35c-8b72-49c8-8823-996bfdee1667">
</iframe>
