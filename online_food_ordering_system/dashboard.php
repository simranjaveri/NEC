...
<div class="container">
	   ...
	   <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#0F802C;border-radius:10px 10px 10px 10px;" role="tablist">
		  ...
		  <li class="nav-item">
              <a class="nav-link" style="color:#BDDEFD;"  id="ManageVendors-tab" data-toggle="tab" href="#ManageVendors" role="tab" aria-controls="ManageVendors" aria-selected="false">Manage Delivery People</a>
          </li>
		  <li class="nav-item">
...
<!--tab 1 ends-->	   
            ...
            <div class="tab-pane fade" id="manageaccount" role="tabpanel" aria-labelledby="manageaccount-tab">
			    <form method="post" enctype="multipart/form-data">
                   ...
                   <div class="form-group">
                     ...
                     <input type="password" name="password" class="form-control" value="<?php if(isset($pass)){ echo $pass;}?>" id="pwd" requigreen/>
                   </div>
				   
				   
 
                  <button type="submit" name="update" style="background:#0F802C; border:1px solid #0F802C;" class="btn btn-primary">Update</button>
                  <div class="footer" style="color:green;"><?php if(isset($ermsg)) { echo $ermsg; }?><?php if(isset($ermsg2)) { echo $ermsg2; }?></div>
			 </form>
			</div>
			<!--tab 2 ends-->
	...
	?>			 
                    ...
                    <tr>
						...
						<form method="post">
                        <td><a href="#"  style="text-decoration:none; color:white;" onclick="delRecord(<?php echo $row['fldvendor_id']; ?>)"><button type="button" class="btn btn-danger">Remove Delivery Person</a></a></td>
                        </form>
                   </tr>
		<?php
		}
		?>		   
			 ...
			 <div class="tab-pane fade" id="orderstatus" role="tabpanel" aria-labelledby="orderstatus-tab">
			   ...
			   {
			   ?>
			   <td><i style="color:orange;" class="fas fa-exclamation-triangle"></i>&nbsp;<span style="color:green;"><?php echo $rrr['fldstatus']; ?></span></td>
			   <?php
			   }
			   else
