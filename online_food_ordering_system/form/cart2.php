                 ...
                 <table class="table">
                  <tbody>
                   ...
                   <?php
						...
						<tr>
					  <td>
					  <h5 style="color:red;">You will receive</h5>
					  </td>
					  <td>
					  ...
					  <a href="/online_food_ordering_system/form/order.php?cust_id=<?php echo $cust_id; ?>"><button type="button" style=" color:white; font-weight:bold; text-transform:uppercase;" class="btn btn-warning">Call for Pickup</button></a>
					  </td>
					  <td></td>
					  </tr>
	                 ...
	                 ?>
					 <tr><button type="button" class="btn btn-outline-success"><a href="/YOUTUBE/" style="color:green; text-decoration:none;">Confirm your order</a></button></tr>
                      &nbsp; &nbsp; &nbsp; &nbsp;
                      
                     <tr><button type="button" class="btn btn-outline-success"><a href="../index.php" style="color:green; text-decoration:none;">Abort</a></button></tr> 
