...
<br><br><br><br><br><br>
   <div class="container">
    <form method="post">
	  ...
	  <div class="col-sm-4">Delivered to location<input type="radio"  name="status" value="Delivered">&nbsp;&nbsp;&nbsp;Collected from Farmer<input type="radio"  name="status" value="Out of Stock"><br>
	  <br>
